...
from rr.views_api.serviceprovider import SamlServiceProviderViewSet
...
class ServiceTestCase(APITestCase):
    def setUp(self):
        ...
        self.object = ServiceProvider.objects.create(
            entity_id="https://sp2.example.org/sp", service_type="saml", name_en="My Test"
        )
        self.object.admins.add(self.user)
        self.super_user_object = ServiceProvider.objects.create(entity_id="test:entity:1", service_type="saml")
        self.data = {"id": self.object.id, "entity_id": self.object.entity_id}
        self.create_data = {"entity_id": "New:Service", "name_en": "New SAML ServiceProvider"}
        self.update_data = {"id": self.object.id, "entity_id": self.object.entity_id, "name_en": "Your test"}
        self.url = "/api/v1/services/saml/"
        self.viewset = SamlServiceProviderViewSet
