...
class ServiceTestCase(APITestCase):
    def setUp(self):
        ...
        self.object = ServiceProvider.objects.create(service_type="ldap", name_fi="My Test LDAP")
        ...
        self.data = {"id": self.object.id, "name_fi": self.object.name_fi}
