...
class ServiceTestCase(APITestCase):
    def setUp(self):
        ...
        self.object = ServiceProvider.objects.create(entity_id='test.service', service_type='oidc',
                                                     name_en='My Test')
        ...
        self.create_data = {'entity_id': 'NewService',
                            'name_en': 'New OIDC ServiceProvider'}
