...
class ServiceTestCase(APITestCase):
    def setUp(self):
        ...
        self.object = ServiceProvider.objects.create(entity_id='https://sp2.example.org/sp', service_type='saml',
                                                     name_en='My Test')
        ...
        self.create_data = {'entity_id': 'New:Service',
                            'name_en': 'New SAML ServiceProvider'}
        self.update_data = {'id': self.object.id,
                            'entity_id': self.object.entity_id,
                            'name_en': 'Your test'}
