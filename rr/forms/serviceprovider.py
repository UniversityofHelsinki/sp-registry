...
class LdapTechnicalInformationForm(ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            ...
            'service_account_contact': _('Email and phone number for delivering service account credentials. Use a firstname.lastname@helsinki.fi address and the same person\'s mobile phone in non-international format, that is, start it with 0. Separete the email and phone number by space.'),
