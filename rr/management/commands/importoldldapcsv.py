...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument("-i", type=str, action="store", dest="file", help="LDAP CSV file")
        parser.add_argument(
            "-o",
            action="store_true",
            dest="overwrite",
        ...
        parser.add_argument("-a", action="store_true", dest="validate", help="Validate imported data automatically")
