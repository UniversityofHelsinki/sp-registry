...
def create_test_environment(context):
    ...
    ServiceProvider.objects.create(
        entity_id="https://sp.example.com/sp",
        service_type="saml",
...
@given("additional SP with admin exists")
def create_additional_sp(context):
    u = User.objects.all().first()
    sp = ServiceProvider.objects.create(
        entity_id="https://sp.example.net/sp",
        service_type="saml",
...
def create_test_environment_with_superuser(context):
    ...
    sp.admins.add(u)
    Contact.objects.create(sp=sp, type="technical", firstname="Tech", lastname="Boss", email="technical@example.org")
    ServiceProvider.objects.create(
        entity_id="https://sp.example.com/sp",
        service_type="saml",
        name_en="SP without admins",
