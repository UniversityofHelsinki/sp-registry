...
class AttributeFormTestCase(TestCase):
    def setUp(self):
        ...
        self.attr_uniqueid = Attribute.objects.create(
    ...
    def test_attribute_form_save_content_saml_user(self):
        ...
        self.assertEqual(
            'Name: urn:oid:1.3.6.1.4.1.5923.1.1.1.6 (<a target="_blank" href="https://wiki.eduuni.fi/display/CSCHAKA/funetEduPersonSchema2dot2#funetEduPersonSchema2dot2-eduPersonPrincipalName">schema</a>)',
            form.fields["eduPersonPrincipalName"].help_text,
        )
    ...
    def test_attribute_view_denies_anonymous(self):
        ...
        self.assertRedirects(
            response, reverse("login") + "?next=" + reverse("attribute-list", kwargs={"pk": self.user_sp.pk})
        )
