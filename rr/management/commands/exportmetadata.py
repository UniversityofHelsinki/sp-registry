...
from rr.utils.saml_metadata_generator import saml_metadata_generator_list, saml_metadata_generator
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('-d', type=str, dest='metadata_dir',
                            help='Metadata directory for individual files')
    ...
    def handle(self, *args, **options):
        ...
        if not metadata_dir:
            ...
            metadata_list = saml_metadata_generator_list(validated,
                                                         privacypolicy,
                                                         production,
                                                         test,
                                                         include,
