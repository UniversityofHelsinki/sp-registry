...
TESTDATA_MINIMAL_ORGANIZATION_FILENAME = os.path.join(os.path.dirname(__file__),
                                                      '../testdata/metadata_minimal_organization.xml')
...
class MetadataMinimalParserGenerationTestCase(TestCase):
    ...
    def test_metadata_organization_generation(self):
        organization = Organization.objects.create(name_fi="Testiorganisaatio",
