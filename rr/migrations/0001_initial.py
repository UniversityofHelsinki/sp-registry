    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description_fi', models.CharField(blank=True, max_length=255, verbose_name='Service Description (Finnish)')),
                ('description_en', models.CharField(blank=True, max_length=255, verbose_name='Service Description (English)')),
                ('description_sv', models.CharField(blank=True, max_length=255, verbose_name='Service Description (Swedish)')),
                ('privacypolicy_fi', models.URLField(blank=True, max_length=255, verbose_name='Privacy Policy URL (Finnish)')),
                ('privacypolicy_en', models.URLField(blank=True, max_length=255, verbose_name='Privacy Policy URL (English)')),
                ('privacypolicy_sv', models.URLField(blank=True, max_length=255, verbose_name='Privacy Policy URL (Swedish)')),
                ('login_page_url', models.URLField(blank=True, max_length=255, verbose_name='Service Login Page URL')),
                ('discovery_service_url', models.URLField(blank=True, max_length=255, verbose_name='Discovery Service URL')),
                ('name_format_transient', models.BooleanField(default=False, verbose_name='urn:oasis:names:tc:SAML:2.0:nameid-format:transient')),
                ('name_format_persistent', models.BooleanField(default=False, verbose_name='urn:oasis:names:tc:SAML:2.0:nameid-format:persistent')),
                ('encyrpt_attribute_assertions', models.BooleanField(default=False, verbose_name='Encrypt attribute assertions')),
