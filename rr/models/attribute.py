...
class Attribute(models.Model):
    ...
    schemalink = models.BooleanField(default=True,
                                     verbose_name=_('Show link to funetEduPerson-schema'))
    ...
    shib_env = models.CharField(blank=True, max_length=255,
                                verbose_name=_('Shibboelth environmental variable for the attribute'))
